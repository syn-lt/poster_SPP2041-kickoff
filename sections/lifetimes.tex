...
\begin{overpic}[width=\columnwidth]%
  ...
  \put(52,28){\normalfont \textbf{B}}
\end{overpic}
  \captionof{figure}{\label{fig:lifemub}}

  \vspace{3cm}
  
In future work we will compare with .
